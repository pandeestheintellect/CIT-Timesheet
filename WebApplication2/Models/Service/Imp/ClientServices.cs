...
namespace Eng360Web.Models.Service.Imp
{
    public class ClientServices : IClientServices
    {
        ...
        public int CreateClient(ClientViewModel eng_client_master)
        {
            return clientRepository.CreateClient(eng_client_master);
        }
        public int SaveClient(ClientViewModel client)
        {
