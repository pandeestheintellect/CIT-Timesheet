...
namespace Eng360Web.Controllers
{
    ...
    public class ClientController : SuperBaseController
    {
        ...
        public ClientController(IClientServices _clientService, IEmployeeServices _employeeService,ISupplierServices _supplierService)
        {
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.Country = supplierService.getAllcountry().Where(a => a.id == client.Clientcountry).Select(a => a.name).FirstOrDefault();
        ...
        public ActionResult Create()
        {
            ...
            var clientcountry = supplierService.getAllcountry().ToList();
            clientcountry.Insert(0, new countryViewModel { id = 0, name = "-Select-" });
            ViewBag.Clientcountry = new SelectList(clientcountry, "id", "name");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(ClientViewModel eng_client_master)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = clientService.CreateClient(eng_client_master);
                if (result > 0)
                {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            {
                ClientCountry.Insert(0, new countryViewModel() { id = 0, name = "-Select-" });
                ViewBag.ClientCountry = new SelectList(ClientCountry, "id", "name", client.Clientcountry);
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(ClientViewModel eng_client_master)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = clientService.SaveClient(eng_client_master);
