...
namespace Eng360Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private void StartAutoMapper()
        {
            ...
            Mapper.CreateMap<eng_project_permission, ProjectPermissionViewModel>();
            Mapper.CreateMap<ProjectPermissionViewModel, eng_project_permission>();
            ...
            Mapper.CreateMap<LeaveSettingViewModel, eng_leave_settings>();
            Mapper.CreateMap<eng_leave_settings, LeaveSettingViewModel>();


            Mapper.CreateMap<RoleViewModel, eng_role>();
            Mapper.CreateMap<eng_role, RoleViewModel>();

            Mapper.CreateMap<HolidayViewModel, eng_holiday>();
            Mapper.CreateMap<eng_holiday, HolidayViewModel>();


            Mapper.CreateMap<LeaveMasViewModel, eng_leave_master>();
            Mapper.CreateMap<eng_leave_master, LeaveMasViewModel>();

            Mapper.CreateMap<ProjectNewViewModel, eng_project>();
            Mapper.CreateMap<eng_project, ProjectNewViewModel>();
            ...
            Mapper.CreateMap<countryViewModel, countryMaster>();
            Mapper.CreateMap<countryMaster, countryViewModel>();

            Mapper.CreateMap<ClaimFilesViewModel, eng_claim_files>();
            Mapper.CreateMap<eng_claim_files, ClaimFilesViewModel>();
            Mapper.CreateMap<TimeEntrySubmitViewModel, eng_time_entry_submit>();
            Mapper.CreateMap<eng_time_entry_submit, TimeEntrySubmitViewModel>();
            ...
            Mapper.CreateMap<HolidayMasterViewModel, eng_holiday>();
            Mapper.CreateMap<eng_holiday, HolidayMasterViewModel>();


            Mapper.CreateMap<PEMappingViewModel, eng_project_permission>();
            Mapper.CreateMap<eng_project_permission, PEMappingViewModel>();
            ...
            Mapper.CreateMap<TimeEntryMasterViewModel, eng_time_entry_master>();
            Mapper.CreateMap<eng_time_entry_master, TimeEntryMasterViewModel>();

            Mapper.CreateMap<TimeEntryGridViewModel, eng_time_entry_grid>();
            Mapper.CreateMap<eng_time_entry_grid, TimeEntryGridViewModel>();
        }
